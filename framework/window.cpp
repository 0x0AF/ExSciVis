...
Window::Window(glm::ivec2 const &windowsize) : m_window(nullptr), m_size(windowsize), m_title("ExSciVis"), m_mousePosition(), m_mouseButtonFlags(0), m_keypressed()
{
...
bool Window::shouldClose() const { return 0 != glfwWindowShouldClose(m_window); }
...
void Window::stop() { glfwSetWindowShouldClose(m_window, GL_TRUE); }
void Window::update()
{
...
void Window::resize(glm::ivec2 const &windowsize) { glfwSetWindowSize(m_window, windowsize.x, windowsize.y); }
